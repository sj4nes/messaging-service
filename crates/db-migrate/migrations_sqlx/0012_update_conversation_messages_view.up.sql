-- Update conversation_messages view to populate body_text from dedup tables (clean follow-up)
DO $$
BEGIN
  ...
  ELSE
    RAISE NOTICE 'Skipping view update (0012): required tables not found';
  END IF;
END$$;
